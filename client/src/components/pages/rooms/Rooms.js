    ...
    <div className="Rooms">
      ...
      >
        <div className="header-content">
          ...
          <p>
            Our generous guest rooms at Balaji Resort boast breathtaking views and
            exclusive amenities
          </p>
        </div>
          ...
          rooms.map((room) => (
            <article className="card" key={room.title}>
              ...
              <div>
                ...
                <p>Balaji resort is one of the best hotel of Goa. We provide accomodation according to user <br/> requirement depending upon number of adult and children. We provide breakfast, lunch and dinner made by India's best chef.</p>
              </div>
